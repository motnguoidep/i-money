      ...
      <div class="text-center">
        <div class="w-24 h-24 rounded-full overflow-hidden mx-auto">
          <img
            ...
            src="https://i.pinimg.com/originals/68/28/9b/68289b2e4fa9a352082a2c89ec766447.jpg"
            alt="User's Profile Avatar"
          />
        </div>
        <div class="font-bold text-2xl text-pink-400 mt-3">
          {{ user.displayName }}
        </div>
    ...
    <div class="container mx-auto px-8">
      <div class="grid grid-cols-1">
        <div class="col-span-1">
          <h3 class="font-bold text-xl text-pink-400 mb-2">General</h3>
        </div>
      </div>
      <div class="grid grid-cols-1">
        <div class="col-span-1">
